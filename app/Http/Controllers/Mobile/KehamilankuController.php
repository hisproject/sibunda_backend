    ...
    public function getOverview() {
        ...
        foreach($janin as $j) {
            ...
            $j->food_recommendations = [
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_1.png'),
                ...
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_2.png'),
                ...
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_3.png'),
                ...
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_4.png'),
                ...
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_5.png'),
                ...
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_6.png'),
                    'food_category' => 'Minyak / Lemak',
                    'food_dose' => 'Bunda, 1 hari minimal harus makan 4 porsi protein nabati ya, dengan 1 porsi = 50 gr atau 1 potong sedang tempe, dan 1 porsi = 100 gr atau 2 potong sedang tahu',
                ],
                [
                    'img_url' => $this->getResourceUrl('/res/img/kehamilanku/rekomendasi_7.png'),
                    'food_category' => 'Gula',
