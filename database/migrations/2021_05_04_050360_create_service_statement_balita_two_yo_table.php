...
class CreateServiceStatementBalitaTwoYoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_statement_balita_two_yo', function (Blueprint $table) {
            $table->id();
            $table->string('bb');
            $table->string('pb');
            $table->string('lk');
    ...
    {
        Schema::dropIfExists('service_statement_balita_two_yo');
    }
}
